...
const PieCharts = () => {
  ...
  const { data, isError, isLoading } = usePieQuery(userId!);

  const charts = data?.charts;

  if (isError) <Navigate to={"/admin/dashboard"}/>
            ...
            <section>
              <div>
                <PieChart
                  ...
                  data={[
                    charts?.orderFulfilment.processing ?? 0,
                    charts?.orderFulfilment.shipped ?? 0,
                    charts?.orderFulfilment.delivered ?? 0,
                  ]}
                  backgroundColor={[
                    `hsl(110,80%, 80%)`,
                    `hsl(110,80%, 50%)`,
              ...
              <div>
                <DoughnutChart
                  ...
                  backgroundColor={categories.map(
                    (i) =>
                      `hsl(${Number(Object.values(i)[0]) * 4}, ${
                        Object.values(i)[0]
                      }%, 50%)`
                  )}
                  legends={false}
